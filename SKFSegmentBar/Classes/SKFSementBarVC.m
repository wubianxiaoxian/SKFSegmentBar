...
@interface SKFSementBarVC ()<SKFSegmentBarDelegate, UIScrollViewDelegate>
@property (nonatomic, weak) UIScrollView *contentView;

@end

@implementation SKFSementBarVC
#pragma mark   ------------- 懒加载 --------------
- (SKFSegmentBar *)segmentBar {
    if (!_segmentBar) {
        SKFSegmentBar *segmentBar = [SKFSegmentBar segmentBarWithFrame:CGRectZero];
